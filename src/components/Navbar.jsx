  ...
  return (
    <>
      <main className="fixed top-0 z-30 flex w-full justify-center border-b-[1px] border-white/20" style={{ opacity: 1, transform: "none", backdropFilter: "blur(10px)" }}>
        <nav className="z-2 flex w-full max-w-[1200px] items-center justify-center gap-20 py-[18px] max-xl:px-[16px] max-sm:border-b-[1px] max-sm:border-white/20 max-sm:py-[11px]">
            {navs.map((nav, index) => (
