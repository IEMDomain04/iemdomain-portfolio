        ...
        <main>
            <section className='flex flex-wrap gap-y-20 gap-x-5'>
                {displayedProjects.map((project, index) => (
                    <section key={index}> 
                            <img className='rounded-lg mb-5 max-sm:justify-self-center duration-500 shadow-lg cursor-pointer hover:scale-105 hover:shadow-slate-400' onClick={() => window.open(project.href, '_blank')} loading='lazy' src={project.src} height={480} width={300} alt={project.alt} />
